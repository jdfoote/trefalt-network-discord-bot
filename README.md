...
7. Set up roles on Discord. The bot expects that the user running the game has the "Teachers" role and the people playing have the "Students" role.
8. Set up a voice channel that starts with "class-sessions". The bot uses the list of people in that channel as the list of people who are playing the game.
6. Run the bot
